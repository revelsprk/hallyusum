...
export default function Header() {
    return (
        <div className="bg-white/25 backdrop-blur-3xl sticky top-0 px-8 h-16 flex items-center overflow-hidden">
            <Link href="/"><Image src="/logo.svg" alt="Logo" width={100} height={100} className="h-8 hover:md:h-10 duration-200 w-full" /></Link>
